...
OptiMarket, Java dili kullanılarak Android Studio ortamında geliştirilmiş ve nesne yönelimli programlama (OOP) prensiplerini temel alan bir pazar yeri simülasyonu mobil uygulamasıdır. 
...
Kullanıcı Bakiyesi: İşlemlere bağlı olarak güncellenen sanal cüzdan sistemi.
...
Konsept: Object Oriented Programming (OOP)
...
Gerekli SDK ve kütüphanelerin yüklenmesini bekleyin.

Bir emülatör veya fiziksel cihaz üzerinde çalıştırın.
